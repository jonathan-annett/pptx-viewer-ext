...
} from 'pptx-tools-core/sync/previewContext';
...
import { renderPlanPairs, toViewModel } from 'pptx-tools-core/sync/planHtml';
import { readManifest } from 'pptx-tools-core/sync/manifest';
import { renderCompareModalHtml, renderIdenticalModalHtml } from 'pptx-tools-core/sync/compareModalHtml';

...
import type { SearchHit } from 'pptx-tools-core/search/index-types';
...
import { renderSearchPanelHtml } from 'pptx-tools-core/search/searchPanelHtml';
import { groupHitsByFolder, folderLabelFor } from 'pptx-tools-core/search/scope';
import {
  renderSearchUpdateModalHtml,
  renderSearchUpdateIdenticalModalHtml,
} from 'pptx-tools-core/search/updateModalHtml';
import { getParseCacheSingleton, parsePptxCached } from 'pptx-tools-core/sync/parseCache';

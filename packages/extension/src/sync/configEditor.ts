...
import { parseSyncConfigText, type SyncConfig } from 'pptx-tools-core/sync/configParse';
import { renderConfigEditorHtml } from 'pptx-tools-core/sync/configEditorHtml';
import {
  configFilenameFromUri,
  isWorkspaceRootNamedConfig,
  roomSyncHandle,
} from 'pptx-tools-core/sync/configFilenames';
import { pathEndsWithManifestFilename } from 'pptx-tools-core/sync/manifestFilenames';
import {
  renderPlanChips,
  renderPlanPairs,
  toViewModel,
  type PlanTotals,
} from 'pptx-tools-core/sync/planHtml';
import type { PlanForDestination } from './coreTypes';
import { buildScopedDryRunPlan } from 'pptx-tools-core/sync/planner';
...
import {
  ...
  type RowDecision,
} from 'pptx-tools-core/sync/decisions';

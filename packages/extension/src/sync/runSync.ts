...
import type { PlanItem } from 'pptx-tools-core/sync/plan';
import { readManifest, writeManifest } from 'pptx-tools-core/sync/manifest';
import {
...
} from 'pptx-tools-core/sync/executor';
import type { RowDecision } from 'pptx-tools-core/sync/decisions';
import { manifestKey } from 'pptx-tools-core/sync/manifest-types';
import { sha256Hex } from 'pptx-tools-core/sync/hash';
import { getHashCacheSingleton } from 'pptx-tools-core/sync/hashCache';
import { vscodeFs } from './vscodeFs';
import { sweepOrphanTmpFiles } from 'pptx-tools-core/sync/orphanSweep';
...
export async function runSync(
  ...
  const cache = getHashCacheSingleton() as
    | undefined
    | import('pptx-tools-core/sync/hashCache').UriHashCache<vscode.Uri>;

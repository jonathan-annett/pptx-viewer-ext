...
import { buildDryRunPlan, buildScopedDryRunPlan } from 'pptx-tools-core/sync/planner';
import type { ResolvedTopology } from './coreTypes';
import { renderPlanHtml, toViewModel } from 'pptx-tools-core/sync/planHtml';
import { runSync, formatRunSummary, type RunSummary } from './runSync';
import { manifestUri, resolveManifestUri } from 'pptx-tools-core/sync/manifest';
import {
  countAccepted,

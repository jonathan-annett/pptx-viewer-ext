...
import { isDestinationOnlyTopology } from 'pptx-tools-core/sync/destinationOnly';
import type { SyncManager } from './manager';
import { readManifest, resolveManifestUri } from 'pptx-tools-core/sync/manifest';
import type { ManifestSummary } from './statusBarOperator';
import { SYNC_CONFIG_GLOB } from 'pptx-tools-core/sync/configFilenames';
import {
  MANIFEST_GLOB,
  PREFERRED_MANIFEST_FILENAME,
  pathEndsWithManifestFilename,
} from 'pptx-tools-core/sync/manifestFilenames';

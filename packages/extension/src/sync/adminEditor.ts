...
import {
  ...
  type PlaceholderRow,
} from 'pptx-tools-core/sync/adminEditorHtml';
import { findSourceLinksForFolder } from 'pptx-tools-core/sync/folderSourceLinks';
...
import { buildDryRunPlan } from 'pptx-tools-core/sync/planner';

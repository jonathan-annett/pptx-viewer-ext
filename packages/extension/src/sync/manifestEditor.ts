...
import { parseManifestText } from 'pptx-tools-core/sync/manifest-types';
import {
  renderManifestEditorHtml,
  toManifestViewModel,
  type ManifestEditorMode,
} from 'pptx-tools-core/sync/manifestEditorHtml';
import {
  getDestinationOnlyState,
  onDidChangeDestinationOnlyState,
} from './destinationOnlyWired';
import type { ManifestDriftMap } from 'pptx-tools-core/sync/manifestDrift';
import {
  computeDriftMap,
  destRootFromManifestUri,
} from './manifestDriftWired';
import { stripManifestFilenameSuffix } from 'pptx-tools-core/sync/manifestFilenames';
